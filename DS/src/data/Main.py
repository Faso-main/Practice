...
# Configuration
ITEMS_PATH=os.path.join('src','data','344608_СТЕ.csv')
PROCUREMTNS_PATH=os.path.join('src','data','Закупки_TenderHack_20251010.csv')
Proc_Cleaned_PATH=os.path.join('src','data','split.csv')
...
# Split data
df_items.to_csv(os.path.join('src','data','split.csv'), index=False, encoding='utf-8', chunksize=100)
...
#df_procuremts=pd.read_excel(os.path.join('src','data','Закупки_TenderHack_20251010.xlsx'))
